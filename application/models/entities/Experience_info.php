...
defined("BASEPATH") OR exit("No direct script access allowed");
	...
	/**
	* This class  is automatically generated based on the structure of the table. And it represent the model of the experience_info table.
	*/ 

class Experience_info extends Crud {

protected static $tablename = "Experience_info"; 
...
static $typeArray = array('doctor_id' => 'int','position_held' => 'varchar','post_year' => 'varchar');
/*this is a dictionary that map a field name with the label name that will be shown in a form*/ 
static $labelArray = array('ID' => '','doctor_id' => '','position_held' => '','post_year' => '');
...
static $tableAction = array('delete' => 'delete/experience_info', 'edit' => 'edit/experience_info');
...
function getDoctor_idFormField($value = ''){
 ...
 function getPosition_heldFormField($value = ''){
	return "<div class='form-group'>
				<label for='position_held'>Position Held</label>
				<input type='text' name='position_held' id='position_held' value='$value' class='form-control' required />
			</div>";
} 
 function getPost_yearFormField($value = ''){
	return "<div class='form-group'>
				<label for='post_year'>Post Year</label>
				<input type='text' name='post_year' id='post_year' value='$value' class='form-control' required />
			</div>";
} 
