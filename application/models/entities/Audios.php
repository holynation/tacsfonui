...
static $typeArray = array('uploader' => 'varchar','title' => 'varchar','caption' => 'text','path' => 'varchar','status' => 'tinyint','date_created' => 'timestamp');
/*this is a dictionary that map a field name with the label name that will be shown in a form*/ 
static $labelArray = array('ID' => '','uploader' => '','title' => '','caption' => '','path' => '','status' => '','date_created' => '');
...
static $documentField = array('path'=>array('type'=>array('mp3','aif','aiff','au','flac','m4a','ogg','snd','wav','w64'),'size'=>'94371840','directory'=>'audios/','preserve'=>false)); //array containing an associative array of field that should be regareded as document field. it will contain the setting for max size and data type.;
static $relation = array();
// static $tableAction = array('delete' => 'delete/audios', 'edit' => 'edit/audios');
static $tableAction = array('delete' => array('delete/audios','path'), 'edit' => 'edit/audios');
 ...
 function getPathFormField($value = ''){
	...
	return "<div class='form-group row'>
				...
				<label class='custom-file'>
					<input type='file' name='path' id='path' class='custom-file-input' required $disabled />
