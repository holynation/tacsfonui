...
static $typeArray = array('uploader' => 'varchar','title' => 'varchar','caption' => 'text','audios_path' => 'varchar','status' => 'tinyint','date_created' => 'timestamp');
/*this is a dictionary that map a field name with the label name that will be shown in a form*/ 
static $labelArray = array('ID' => '','uploader' => '','title' => '','caption' => '','audios_path' => '','status' => '','date_created' => '');
...
static $documentField = array('audios_path'=>array('type'=>array('mp3','aif','aiff','au','flac','m4a','ogg','snd','wav','w64'),'size'=>'94371840','directory'=>'audios/','preserve'=>false)); //array containing an associative array of field that should be regareded as document field. it will contain the setting for max size and data type.;
